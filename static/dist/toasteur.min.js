          ...
          void 0 !== module &&
            (module.exports = class {
              constructor(
                ...
                let notificationOnTop = "top" === notificationPosition;
                if (
                  ((this.fadeOutTimeout = fadeOutTimeout),
                  (this.initialized = !1),
                  (this.init = () => {
                    if (
                      document.querySelector(".toasteur-container." + position)
                    )
                      return (
                        (this.container = document.querySelector(
                          ".toasteur-container." + position
                        )),
                  ...
                  throw new Error(
                    "Invalid position, expected one of: top-right, top-left, bottom-right, bottom-left"
                  );
